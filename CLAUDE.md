...
AI parts use free-tier LLMs: NVIDIA NIM primary for reviews/context, Groq for
summaries, GitHub Models last fallback (`scripts/llm_client.py`). Architecture: [`README.md`](README.md#architecture).
